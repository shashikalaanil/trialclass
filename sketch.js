...
function preload(){
  ...
  //zombieImg1 = loadImage("assets/zombie1.gif")
...
function enemy(){
  if(frameCount%70===0){
    ...
    var y=player.y+random(-50,100)
    zombie = createSprite(random(800,1100),y,40,40)
...
function bats(){
  if(frameCount%200==0){
    bat=createSprite(200,100);
    bat.addImage(batImg);
    bat.scale=0.75
    bat.velocityX=random(-9,9);
    bat.velocityY=random(-9,9);
